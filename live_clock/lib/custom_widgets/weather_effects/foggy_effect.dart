...
class FoggyEffect extends StatefulWidget {
  @override
  _FoggyEffectState createState() => _FoggyEffectState();
}

class _FoggyEffectState extends State<FoggyEffect> with TickerProviderStateMixin<FoggyEffect> {
  @override
    ...
    return AnimatedEffectBackground(
      behaviour: RandomParticleBehaviour(
          ...
          options: ParticleOptions(
              ...
              spawnMinRadius: 200.0,
              spawnMaxRadius: 400.0,
              spawnMinSpeed: 20.0,
              spawnMaxSpeed: 40.0,
              minOpacity: 0.1,
              maxOpacity: 0.4
...
/// Convert a widget image into a dart:ui image
///
...
Function() convertImage(Image image, Function(ui.Image) callback) {
