...
class AnimatedEffectBackground extends RenderObjectWidget {
  ...
  @override
  _AnimatedEffectBackgroundElement createElement() => _AnimatedEffectBackgroundElement(this);
}

class _AnimatedEffectBackgroundElement extends RenderObjectElement {
  _AnimatedEffectBackgroundElement(AnimatedEffectBackground widget) : super(widget);

  @override
  AnimatedEffectBackground get widget => super.widget;
  ...
  @override
  void update(AnimatedEffectBackground newWidget) {
  ...
  void _layoutCallback(BoxConstraints constraints) {
    owner.buildScope(this, () {
      ...
      Widget built = widget.behaviour.builder(this, constraints, widget.child);
