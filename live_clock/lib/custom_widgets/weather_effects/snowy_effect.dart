...
class SnowyEffect extends StatefulWidget {
  @override
  _SnowyEffectState createState() => _SnowyEffectState();
}




class _SnowyEffectState extends State<SnowyEffect> with TickerProviderStateMixin<SnowyEffect>{
  @override
